...
const QuotesArray = [
    ...
    "God is the voice that tells Abraham: If you follow the call of adventure it will be a blessing to yourself. And that is the meaning of life. It's a reason to get up in the morning, even if you're in pain.",
];
